...
from .views import JobDescriptionUploadView, JDResultUpdateView, ResumeScreeningAPIView, check_ai_resume, LinkedInProfileScraper
...
urlpatterns = [
    ...
    path("scrap/", LinkedInProfileScraper.as_view(), name="linkedin_scraping"),
]
